...
This thesis will investigate exactly how that can be achieved in order to deliver a MEGAphone device chassis, supporting existing PCBs and hardware-implemented user interface that embodies the vision of UD and DS.\vspace{5mm} %%go through an abbreviate digital sov, also revise
