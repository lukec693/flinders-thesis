...
This thesis will investigate exactly how that can be achieved in order to deliver a MEGAphone device chassis, supporting PCBs and hardware-implemented user interface that embodies the vision of UD and by extent, Digital Sovereignty. %%go through an abbreviate digital sov
%%% MAYBE ADD THIS TO CONCLUDING CHAPTER INSTEAD